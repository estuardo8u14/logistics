...
const Input = tw.input`border-2 px-5 py-3 rounded focus:outline-none font-medium transition duration-300 hocus:border-black`;
...
export default ({
  ...
  heading = (
    <>
      Siéntase libre <span tw="text-blue-700">de ponerse en contacto </span>
      <wbr />
      con nosotros.
    </>
  ),
